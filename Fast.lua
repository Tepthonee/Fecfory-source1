...
function Dev(msg) 
ok = false
local list = {Sudo_Id,1260465030,5961581438}
...
local Info_User = Redis:get(Fast.."Twasl:UserId"..Message_Get.forward_info.date) or 5577318258
if text == 'حظر' then
...
keyboard.inline_keyboard = {
{
{text = '≠مبرمج السورس≠', url = "https://t.me/PPF22"}
},
{  
{text = '≠ 𝑅𝐴𝑁𝐾𝑆≠', url = 't.me/crvso '},
},
...
local msgg = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendvideo?chat_id=" .. msg.chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '⦁ سورس' or text == '≠ سورس' or text == 'يا سورس' or text == 'source' then
photo = "https://t.me/Ranksahhah/13"
local T =[[
 [≠𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐈𝐍 𝐒𝐎𝐔𝐑𝐂𝐄 𝑅𝐴𝑁𝐾𝑆≠](t.me/crvso )
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
